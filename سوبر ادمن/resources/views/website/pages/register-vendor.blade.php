            ...
            <div class="col-span-12">
                <div class="grid grid-cols-12 gap-7">
                    <div class="col-span-12 md:col-span-6">
                        <div class="sigin-left-side bg-mint-600 rounded-3xl p-6
                            ...
                            <div class="content">
                                <div
                                    ...
                                    <img class="h-content" src="../assets/logo/logo-green-sm.png" alt="">
                                </div>
                                <h2
                                    class="text-xl md:text-[28px] font-semibold leading-[120%] text-neutral-100 mb-[10px]">
                                    Welcome to {{ config('app.name', 'Elite Cleaning') }}
                                </h2>
                                <p class="text-base md:text-lg font-normal leading-[140%] text-neutral-100 mb-[24px]">
                                    {{ __('Your trusted partner for professional dry cleaning services') }}
                                </p>
                                <div class="list">
                                    <ul>
                                        <li class="mb-[16px]">
                                ...
                                <div class="box bg-[rgba(255,255,255,0.16)] backdrop-blur-md rounded-2xl p-4 md:p-6">
                                    ...
                                    <div class="log-in-rat flex items-center  ">
                                        <img class="w-[17px] h-[17px]" src="../assets/icons/star-gold.svg" alt="">
                                        <img class="w-[17px] h-[17px]" src="../assets/icons/star-gold.svg" alt="">
                                        <img class="w-[17px] h-[17px]" src="../assets/icons/star-gold.svg" alt="">
                                        <img class="w-[17px] h-[17px]" src="../assets/icons/star-gold.svg" alt="">
                                        <img class="w-[17px] h-[17px]" src="../assets/icons/star-gold.svg" alt="">
                    ...
                    <div class="col-span-12 md:col-span-6">
                        <div class="sigin-right-side bg-white  rounded-3xl
                            ...
                            <form action="#" class="content">
                                ...
                                <div class="login-tab flex items-center justify-between [52px] leading-[40px] p-[6px] bg-mint-50 rounded-[50px] mb-6">
                                    ...
                                    <a class="text-base font-medium leading-[40px] w-[49%] text-center inline-block text-neutral-500 h-[40px] active"
                                        href="../pages/register-customer.html">
                                        Register
                                    </a>
                                </div>
                                <div class="register-btn mb-6 flex gap-3">
                                    <a class="text-lg font-normal leading-[140%] text-neutral-700 h-[108px] inline-block w-[50%] flex flex-col gap-[10px] items-center justify-center border-[1.5px] border-solid border-neutral-200 rounded-xl"
                                        href="../pages/register-customer.html">
                                        <img class="w-[fit-content]" src="../assets/icons/user-grey.svg" alt="">
                                        Customer
                                    </a>
                                    <a class="text-lg font-normal leading-[140%] text-neutral-700 h-[108px] inline-block w-[50%] flex flex-col gap-[10px] items-center justify-center border-[1.5px] border-solid border-neutral-200 rounded-xl active"
                                        href="../pages/register-vendor.html">
                                        <img class="w-[fit-content]" src="../assets/icons/shop-grey.svg" alt="">
                                        Vendor
                                    </a>
                                </div>
                                <div class="input-items mb-4 flex flex-wrap md:flex-nowrap gap-[0] md:gap-3">
                                    <div class="w-full md:w-[50%] mb-4 md:mb-0">
                                        <label
                                            ...
                                            Name</label>
                                        <div class="relative">
                                            <input class="w-full !pl-4" type="text" placeholder="John">
                                        </div>
                                    </div>
                                    <div class="w-full md:w-[50%]">
                                        <label
                                            ...
                                            Name</label>
                                        <div class="relative">
                                            <input class="w-full !pl-4" type="text" placeholder="Doe">
                                        </div>
                                    </div>
                                </div>
                                <div class="input-items mb-4">
                                    <label
                                        class="block text-base md:text-lg font-medium leading-[120%] text-neutral-700 mb-[10px]">Business
                                        Name</label>
                                    <div class="relative">
                                        <input class="w-full !pl-4" type="text" placeholder="Your dry cleaning business">
                                    </div>
                                </div>
                                <div class="input-items mb-4">
                                    <label
                                    ...
                                    <div class="relative">
                                        ...
                                        <input class="w-full" type="email" placeholder="Enter your email address">
                                    </div>
                                </div>
                                <div class="input-items mb-4">
                                    <label
                                    ...
                                    <div class="relative">
                                        ...
                                        <input class="w-full" type="email" placeholder="+1 (555) 123-4567">
                                    </div>
                                </div>
                                <div class="input-items mb-6">
                                    ...
                                    <div class="relative">
                                        <img class="absolute" src="../assets/icons/lock.svg" alt="">
                                ...
                                <div class="flex items-start gap-[10px] mb-6">
                                    ...
                                    <span class="text-base font-normal leading-[150%] text-neutral-500">
                                        I agree to the <a class="text-mint-600" href="#">Terms of Service</a> and <a
                                            class="text-mint-600" href="#">Privacy Policy</a>
                                    </span>
                                </div>
                                <button type="submit"

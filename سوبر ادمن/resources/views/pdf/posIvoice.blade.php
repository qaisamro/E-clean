    ...
    <div style="max-width:400px;margin:0 auto">
        ...
        <div id="receipt-data">
            ...
            <p>
                ...
                <br>
                Pick Date: {{ Carbon\Carbon::parse($order->pick_date)->format('M d, Y') }}
                @if ($order->delivery_date)
                    <br>
                    Delivery Date: {{ Carbon\Carbon::parse($order->delivery_date)->format('M d, Y') }}
                @endif
                <br>
                    ...
                    @foreach ($order->products as $product)
                        ...
                        <tr>
                            <td style="padding-bottom: 0" colspan="2">
                                <h4 style="margin: 0">{{ $product->pivot->title ?: $product->name }}</h4>
                                {{ $product->pivot->quantity }} x {{ currencyPosition($unitPrice) }}
                            </td>
            ...
            <table style="margin-top: 20px">
                <tbody>
                    <tr style="background-color:#ddd;">
                        ...
                        <td style="padding: 5px;width:40%;text-align:center">Paid By: {{ $order->payment_method_label }}</td>

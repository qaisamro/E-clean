...
class MailConfigurationController extends Controller
{
    ...
    public function update(Request $request)
    {
        try {
            ...
            return redirect()->route('mail-config.index')->with('success', 'Mail configuration updated successfully.');
        } catch (\Throwable $e) {
            return redirect()->route('mail-config.index')->with('error', $e->getMessage());
        }
    }
}

...
class FaqController extends Controller
{
    ...
    public function store(FaqRequest $request)
    {
        ...
        return redirect()->route('web.faq.list')->with('success', 'FAQ created successfully.');
    }
    ...
    public function update(FaqRequest $request, $slug)
    {
        ...
        return redirect()->route('web.faq.list')->with('success', 'FAQ updated successfully.');
    }
    ...
    {
        $this->faqRepo->delete($slug);
        return redirect()->route('web.faq.list')->with('success', 'FAQ deleted successfully.');
    }

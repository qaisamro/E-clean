                                ...
                                <div class="row">
                                    ...
                                    <div class="card-icon">
                                        <div class="icon icon-shape text-white shadow">
                                            <img width="80" height="80" src="/images/icons/earning.svg"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="card-icon">
                                        <div class="icon icon-shape text-white shadow">
                                            <img width="80" src="/images/icons/user.svg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="card-icon">
                                        <div class="icon icon-shape text-white shadow">
                                            <img width="80" src="/images/icons/items.svg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="card-icon">
                                        <div class="icon icon-shape text-white shadow">
                                            <img width="80" src="/images/icons/services.svg"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="row">
                    ...
                    <div class="">
                        ...
                        @can('revenue.index')
                            <div class="text-right">
                                <div class="dropdown">
                                    <button class="btn btn-secondary py-1 dropdown-toggle" type="button" id="filter-revunue"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="filter-revunue">
                                        <a class="dropdown-item"
                                            href="{{ route('root', ['type' => 'today']) }}">{{ __('Today') }}</a>
                            ...
                            @can('dashboard.revenue')
                                ...
                                @empty
                                    <tr class="text-center">
                                        <td colspan="5">{{ __('Sorry') }}
                                            {{ ucfirst(\request()->type) ? __(ucfirst(\request()->type)) : __('Today') }}
                                            {{ __('revenue_not_found') }}</td>
                                    </tr>
                                @endforelse
                            @else
                                <tr class="text-center">
            ...
            <div class="col-12 col-lg-4">
                <div class="card" style="border-radius: 10px; border-bottom: 4px solid var(--theme-color);">
                    <div class="overview">
                        <img width="100%" src="/web/bg/overview.svg" alt="">
                        <div>
                    ...
                    @can('dashboard.overview')
                        <div class="row p-3">
                            <div class="col-lg-6 col-4 mb-3">
                                <img width="50" src="/images/icons/users.svg" class="float-left mr-2"
                                    alt="">
                                <div>
                            ...
                            <div class="col-lg-6 col-4 mb-3">
                                <img width="50" src="/images/icons/Orders.svg" class="float-left mr-2"
                                    alt="">
                                <div>
                            ...
                            <div class="col-lg-6 col-4 mb-3">
                                <img width="50" src="/images/icons/Pending.svg" class="float-left mr-2"
                                    alt="">
                                <div>
                            ...
                            <div class="col-lg-6 col-4 mb-3">
                                <img width="50" src="/images/icons/progress.svg" class="float-left mr-2"
                                    alt="">
                                <div>
                            ...
                            <div class="col-lg-6 col-4">
                                <img width="50" src="/images/icons/delivered.svg" class="float-left mr-2"
                                    alt="">
                                <div>
                            ...
                            <div class="col-lg-6 col-4 ">
                                <img width="50" src="/images/icons/order.svg" class="float-left mr-2"
                                    alt="">
                                <div>

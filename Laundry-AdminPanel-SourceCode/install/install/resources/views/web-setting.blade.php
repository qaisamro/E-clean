                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body pb-3">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-2">
                                        <label class="mb-0 text-dark">{{ __('Currency_Symbol') }} <span class="badge badge-primary">الشيكل فقط</span></label>
                                        <div class="input-group">
                                            <input type="text" name="currency" class="form-control" value="₪" readonly required>
                                            <div class="input-group-append"><span class="input-group-text">₪</span></div>
                                        </div>
                                        <small class="text-muted">العملة مثبتة على الشيكل الإسرائيلي (₪)</small>
                                        <input type="hidden" name="currency_name" value="ils">
                                        <div class="mt-2">
                                            <label class="mb-0 text-dark">{{ __('currency_name') }}</label>
                                            <input type="text" class="form-control" value="ILS - Israeli Shekel (₪)" readonly>
                                            <small class="text-muted">كود العملة: ILS</small>
                                        </div>
                                        </div>
                                    ...
                                    <div class="mb-2">
                                        <label class="mb-0 text-dark">{{ __('Tax Rate (%)') }}</label>
                                        <input type="number" step="0.01" name="tax_rate" class="form-control"
                                            value="{{ $websetting?->tax_rate ?? 0 }}" placeholder="{{__('exm:_8.00')}}">
                                    </div>
                        ...
                        <div class="card-footer py-3 ">
                            <div class="d-flex justify-content-end">
                                <button class="btn btn-primary rounded-0">{{ __('Save_And_Update') }}</button>
                            </div>
                        </div>
                    </div>
                </form>

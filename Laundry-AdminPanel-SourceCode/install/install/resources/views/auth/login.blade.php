...
<head>
    ...
    <!-- Fav icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/web/favIcon.png">
    <!-- custome css -->
        ...
        <div class="row">
            <div class="col-12 col-md-7 col-lg-6 login-form-section">
                <div class="login">
                    ...
                    <form role="form" class="pui-form" id="loginform" method="POST" action="{{ route('form-login', ['redirect' => $redirect ?? null], false) }}">
                        @csrf
                        ...
                        <div class="inputBox">
                            ...
                            <div class="terms mt-2 text-muted small">
                                ...
                                <a href="{{ route('web.terms') }}"
                                    class="link-primary text-decoration-none">{{ __('terms_conditions_page_title') }}</a>
                                and
                                <a href="{{ route('web.privacy') }}"
                                    class="link-primary text-decoration-none">{{ __('privacy_policy_page_title') }}</a>.
                            </div>
                        </div>
                        ...
                        @if ($demoMode)
                            <div class="demo-credential-card d-flex align-items-center justify-content-between gap-3">
                                <div>
                                    <h6 class="demo-credential-title">Demo Admin Credentials</h6>
                                    <p class="demo-credential-text mb-0">
                                        Email: {{ config('app.demo_admin_email') }}<br>
                                ...
                                <button
                                    ...
                                    type="button"
                                    title="Fill and login"
                                    aria-label="Fill demo admin credentials and login">

        ...
        <div class="row">
            <div class="col-12 col-md-8 m-auto">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form @role('visitor') action="#" @else action="{{ route('admin.store') }}" @endrole method="POST">
                            @csrf
                            <div class="row pb-5">
                                <div class="col-6">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <button type="submit"
                                        class="btn mt-1 btn-primary w-100 @role('visitor') visitorMessage @endrole">{{ __('Submit') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>

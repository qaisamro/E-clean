...
@section('content')
    ...
    <div id="sidebar-filter"
        ...
        <div class="h-full w-full flex flex-col relative p-4">
            ...
            <div class="overflow-y-auto mt-12">
                <h3 class="text-sm md:text-base font-semibold mb-4">Filter by</h3>
                <form class="mb-4" id="sidebar-filter-form" action="{{ route('web.services') }}" method="GET">
                    ...
                    <label class="text-xs font-medium text-neutral-700">Search</label>
            ...
            <div class="rs-breadcrumb-content">
                ...
                <div class="rs-breadcrumb-top-content">
                    ...
                    <a href="{{ route('web.services') }}"
                        class="text-base md:text-lg text-white font-normal leading-[100%]">Services</a>
                </div>
            </div>
        </section>
                        ...
                        <form action="{{ route('web.services') }}" method="GET" class="mb-4"
                            ...
                            <div class="relative flex items-center">
                                ...
                                <input
                                    ...
                                    type="text" name="search" placeholder="Search services ..."
                                    value="{{ $search ?? '' }}">
                                ...
                                @if ($search)
                                    <button type="button" onclick="clearDesktopSearch()"
                ...
                <div class="rs-services-right-area col-span-12 md:col-span-12 lg:col-span-9">
                    <div class="rs-services-right-top flex items-center justify-between mb-6 flex-wrap gap-4">
                        ...
                        <div class="select-dropdown leading-[41px] text-start relative cursor-pointer border border-neutral-200 rounded-lg px-3 py-1 bg-white"
                            ...
                            <span class="text-sm text-neutral-600">Sort by:</span> <b class="text-sm text-neutral-800"
                                id="current-sort">{{ ucfirst($sort ?? 'recommended') }}</b>
                            ...
                            <ul id="sort-dropdown"
                                ...
                                <li class="px-3 py-2 hover:bg-gray-100 cursor-pointer text-sm rounded"
                                    onclick="applySort('recommended')">Recommended</li>
                                <li class="px-3 py-2 hover:bg-gray-100 cursor-pointer text-sm rounded"
                                    onclick="applySort('low_to_high')">Price: Low to High</li>
                                <li class="px-3 py-2 hover:bg-gray-100 cursor-pointer text-sm rounded"
                                    onclick="applySort('high_to_low')">Price: High to Low</li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div
                                ...
                                <div class="rs-services-thumb relative">
                                    ...
                                    @if ($service->is_popular)
                                        <div class="thumb-popular">Popular</div>
                                    @endif
                                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Search forms will submit naturally via GET method

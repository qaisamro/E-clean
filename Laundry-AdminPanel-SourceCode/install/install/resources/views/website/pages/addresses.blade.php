...
@section('content')
            ...
            <div class="rs-breadcrumb-content">
                ...
                <div class="rs-breadcrumb-top-content">
                    ...
                    <a href="{{ route('web.addresses') }}"
                        class="text-base md:text-lg text-white font-normal leading-[100%]">Addresses</a>
                </div>
            </div>
        </section>
        ...
        <div id="addAddressModal"
            ...
            <div class="bg-white rounded-2xl p-6 w-full max-w-md my-auto">
                ...
                <form action="{{ route('web.addresses.store') }}" method="POST"
                    ...
                    <div class="mb-4">
                        <label class="text-neutral-700 text-base font-medium">House No</label>
                        <input type="text" name="house_no" placeholder="123"
                            class="w-full h-[40px] mt-2.5 border border-neutral-100 rounded-[12px] px-[16px] py-[10px]" />
                    </div>
                    <div class="mb-4">
                        <label class="text-neutral-700 text-base font-medium">Flat No</label>
                        <input type="text" name="flat_no" placeholder="1A"
                            class="w-full h-[40px] mt-2.5 border border-neutral-100 rounded-[12px] px-[16px] py-[10px]" />
                    </div>
                    <div class="mb-4">
                        <label class="text-neutral-700 text-base font-medium">Road No</label>
                        <input type="text" name="road_no" placeholder="Main Road"
                            class="w-full h-[40px] mt-2.5 border border-neutral-100 rounded-[12px] px-[16px] py-[10px]" />
                    </div>
                    <div class="mb-4">
                        <label class="text-neutral-700 text-base font-medium">Block</label>
                        <input type="text" name="block" placeholder="Block"
                            class="w-full h-[40px] mt-2.5 border border-neutral-100 rounded-[12px] px-[16px] py-[10px]" />
                    </div>
                    <div class="mb-4">
                        <label class="text-neutral-700 text-base font-medium">Area</label>
                        <input type="text" name="area" placeholder="Area" required
                            class="w-full h-[40px] mt-2.5 border border-neutral-100 rounded-[12px] px-[16px] py-[10px]" />
                    </div>
                    <div class="mb-4">
                        <label class="text-neutral-700 text-base font-medium">Address Line</label>
                        <input type="text" name="address_line" placeholder="123 Main Road, Apt 6B"
                            class="w-full h-[40px] mt-2.5 border border-neutral-100 rounded-[12px] px-[16px] py-[10px]" />
                    </div>
                    <div class="mb-4">
                        <label class="text-neutral-700 text-base font-medium">Post Code</label>
        ...
        <div id="editAddressModal"
            ...
            <div class="bg-white rounded-2xl p-6 w-full max-w-md my-auto">
                ...
                <form id="editForm" method="POST" class="overflow-y-auto max-h-[calc(100vh-200px)]">
                    ...
                    <div class="mb-4">
                        <label class="text-neutral-700 text-base font-medium">Block</label>
                        <input type="text" name="block" id="edit_block" placeholder="Block"
                            class="w-full h-[40px] mt-2.5 border border-neutral-100 rounded-[12px] px-[16px] py-[10px]" />
                    </div>
                    <div class="mb-4">
                        <label class="text-neutral-700 text-base font-medium">Area</label>
                        <input type="text" name="area" id="edit_area" placeholder="Area"
                            class="w-full h-[40px] mt-2.5 border border-neutral-100 rounded-[12px] px-[16px] py-[10px]" />
                    </div>
                    <div class="mb-4">
                        <label class="text-neutral-700 text-base font-medium">Address Line</label>
            ...
            <div class="rs-manage-addresses-area max-w-2lg mx-auto">
                        ...
                        <div class="rs-manage-addresses-content flex gap-[20px] border-b-[1.5px] border-neutral-200 mb-[20px]">
                            ...
                            <div class="rs-manage-addresses-info">
                                <div class="rs-manage-addresses-info-top flex text-center gap-[12px] mb-[12px]">
                                    <span
                                        class="text-neutral-900 text-base leading-[140%] font-medium">{{ $address->address_name ?? 'Address' }}</span>
                ...
                @empty
                    <div class="bg-white p-8 rounded-3xl text-center">
                        ...
                        <p class="text-gray-500 mb-6">You haven't added any delivery addresses yet.</p>
                        <button type="button" onclick="toggleModal('addAddressModal')"
    ...
    @else
        <section class="py-20 text-center">
            ...
            <p class="text-gray-600 mb-6">You need to login to view your addresses.</p>

...
@section('content')
        ...
        <div class="modal_content">
            <form action="#" class="rs-manage-addresses-form">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" placeholder="{{ __('Example') }} : {{ __('Home') }}, {{ __('Office') }} ..."
    ...
    <main class="space-y-[60px]">
            ...
            <div class="rs-breadcrumb-content">
                ...
                <div class="rs-breadcrumb-top-content">
                    ...
                    <a href="{{ route('web.faq') }}"
                        class="text-base md:text-lg text-white font-normal leading-[100%]">{{ __('FAQ') }}</a>
                </div>
            </div>
        </section>
        ...
        <section class="max-w-2lg mx-auto px-4 xl-1:px-0">
            <div class="w-full">
                ...
                {{-- {{ __('All Questions') }} Section (default) --}}
            ...
            <div class="relative z-10 p-4 flex justify-center items-center flex-col gap-[30px]">
                <div class="space-y-[10px]">
                    ...
                    <p class="text-sm md:text-lg text-center text-gray-700">
                        {{ __("Can't find the answer you're looking for? Our customer support team is here to help.") }}
                    </p>
                </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            // Set "{{ __('All Questions') }}" as selected by default
            filterFaqs('all');

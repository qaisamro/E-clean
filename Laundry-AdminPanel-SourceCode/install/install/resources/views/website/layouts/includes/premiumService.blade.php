@php
    ...
    $titleText = strip_tags($premiumService['title'] ?? 'Our Premium Services');
    if (empty($titleText)) {
        $titleText = 'Our Premium Services';
    }

    // Get subtitle from settings or use default
    $subTitleText =
        $premiumService['sub_title'] ?? 'Professional care for all your laundry needs with competitive pricing';

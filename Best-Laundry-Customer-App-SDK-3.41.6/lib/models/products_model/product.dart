...
class Product {
  ...
  factory Product.fromMap(Map<String, dynamic> data) => Product(
        ...
        vendorId: (data['vendor'] != null && data['vendor']['id'] != null) ? (data['vendor']['id'] as int?) : data['vendor_id'] as int?,
        vendorName: (data['vendor'] != null && data['vendor']['name'] != null) ? data['vendor']['name'] as String? : data['vendor_name'] as String?,
      );

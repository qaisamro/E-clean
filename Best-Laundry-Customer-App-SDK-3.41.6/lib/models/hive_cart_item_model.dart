...
class CarItemHiveModel {
  ...
  factory CarItemHiveModel.fromMap(Map<String, dynamic> map) {
    return CarItemHiveModel(
      productsId: map['productsId'] is int
          ? map['productsId'] as int
          : int.tryParse(map['productsId'].toString()) ?? 0,
      subproductsId:
          map['subproductsId'] != null ? map['subproductsId'] as int : null,
      productsQTY: map['productsQTY'] is int
          ? map['productsQTY'] as int
          : int.tryParse(map['productsQTY'].toString()) ?? 1,
  ...
  @override
  String toString() {
    return 'CarItemHiveModel(productsId: $productsId, subproductsId: $subproductsId, productsQTY: $productsQTY, unitPrice: $unitPrice, productsName: $productsName, productsImage: $productsImage, serviceName: $serviceName, subProduct: $subProduct, vendorId: $vendorId, vendorName: $vendorName)';
  }

      ...
      child: Container(
        ...
        child: Column(
          children: [
            Row(
              children: [
                Image.asset(widget.image, height: 28.h, width: 28.w),
                SizedBox(width: 6.w),
                Expanded(
                  child: RichText(
                    maxLines: 1,
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(text: widget.title, style: AppTextDecor.osBold14black.copyWith(fontSize: 12.sp)),
                        TextSpan(text: ' *', style: AppTextDecor.osBold14red.copyWith(fontSize: 12.sp)),
                      ],
                    ),
                  ),
                ),

              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    ...
                    SizedBox(width: 12.w),
                    Expanded(child: Text(S.of(context).privacyPolicy, style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w900, color: Colors.white, fontFamily: 'Cairo'))),
                    Container(width: 36.w, height: 36.h, decoration: BoxDecoration(color: Colors.white.withOpacity(0.18), shape: BoxShape.circle), child: Icon(Icons.lock_outline_rounded, size: 18.sp, color: Colors.white)),
                  ]),
                  SizedBox(height: 8.h),
                  Text('نحن نحمي بياناتك بعناية فائقة', style: TextStyle(fontSize: 11.5.sp, color: Colors.white.withOpacity(0.92))),
                ],
              ),
            ),
          ),
            ...
            child: ref.watch(privacyProvider).map(
                  ...
                  loaded: (_) => SingleChildScrollView(
                    ...
                    child: Container(
                      ...
                      child: Html(
                        style: {'*': Style(color: const Color(0xFF1E293B), fontSize: FontSize(13.sp), lineHeight: LineHeight(1.7), fontFamily: 'Cairo')},

              ...
              child: Column(
                children: [
                  Row(children: [
                    ...
                    const Spacer(),
                    Text(S.of(context).abtus, style: TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w900, color: Colors.white, fontFamily: 'Cairo')),
                    const Spacer(),
                    SizedBox(width: 38.w),
                  ]),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(color: Colors.white, shape: BoxShape.circle, boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.12), blurRadius: 14)]),
                    child: Image.asset('assets/images/logo.png', height: 56.h, width: 56.w, fit: BoxFit.contain),
                  ),
                  SizedBox(height: 10.h),
                  Text('نوصلك بأفضل المتاجر بلمسة واحدة', style: TextStyle(fontSize: 12.5.sp, color: Colors.white.withOpacity(0.92))),
                ],
              ),
            ),
          ),
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(gradient: const LinearGradient(colors: [Color(0xFF028090), Color(0xFF00A896)]), borderRadius: BorderRadius.circular(20.r)),
                          child: Row(children: [
                            Container(width: 40.w, height: 40.h, decoration: BoxDecoration(color: Colors.white.withOpacity(0.18), shape: BoxShape.circle), child: Icon(Icons.verified_rounded, size: 18.sp, color: Colors.white)),
                            SizedBox(width: 12.w),
                            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('موثوق من آلاف العملاء', style: TextStyle(fontSize: 13.sp, fontWeight: FontWeight.w900, color: Colors.white)), Text('خدمة سريعة وآمنة على مدار الساعة', style: TextStyle(fontSize: 11.sp, color: Colors.white.withOpacity(0.92)))])),
                          ]),
                        ),
                      ],
                    ),

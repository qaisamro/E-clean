...
return [
    ...
    'permissions' => [
        ...
        'offer.index' => ['root', 'visitor'],
        'offer.create' => ['root', 'visitor'],
        'offer.store' => ['root', 'visitor'],
        'offer.edit' => ['root', 'visitor'],
        'offer.update' => ['root', 'visitor'],
        'offer.destroy' => ['root', 'visitor'],
        'offer.status.toggle' => ['root'],

        'order.index' => ['root', 'visitor'],
        'order.show' => ['root', 'visitor'],
        'order.edit' => ['root', 'visitor'],
        'order.update' => ['root', 'visitor'],
        'order.delete' => ['root'],
        'order.edit.price' => ['root', 'visitor'],
        'order.payment-status' => ['root', 'visitor'],

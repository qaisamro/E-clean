...
<section class=" max-w-2lg mx-auto px-4 xl-1:px-0 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-[70px]">
    <div class="flex flex-col justify-center">
        ...
        <div>
            ...
            <p class="text-base lg:text-lg font-medium text-left text-neutral-700">
                {{ $join['description'] ??
                    __('Partner with Elite Cleaning and connect with customers who need your services. No setup fees, flexible pricing, and instant access to our growing customer base.') }}
        ...
        @php
            $lists = !empty($join['lists'])
                ? $join['lists']
                : [
                    ['list' => __('Commission-based pricing (no hidden fees)')],
                    ['list' => __('Get paid weekly via direct deposit')],
                    ['list' => __('Free marketing and customer acquisition')],
                ];
        @endphp
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-7">
                ...
                <div
                    ...
                    <div class="space-y-[10px]">
                        <p class="text-base font-semibold text-left text-neutral-900 group-hover:text-white">
                            {{ !empty($facility['title']) ? $facility['title'] : __('Grow Your Business') }}
                        </p>

                        <p class="text-sm text-left text-neutral-500 group-hover:text-white">
                            {{ !empty($facility['description']) ? $facility['description'] : __('Reach thousands of customers actively searching for dry cleaning services in your area.') }}
                        </p>
                    </div>
        ...
        @else
            ...
            <div
                ...
                <div class="space-y-[10px]">
                    <p class="text-base font-semibold text-left text-neutral-900 group-hover:text-white">{{ __('Grow Your Business') }}</p>
                    <p class="text-sm text-left text-neutral-500 group-hover:text-white">{{ __('Reach thousands of customers actively searching for dry cleaning services in your area.') }}</p>
                </div>
            </div>
            <div
                class="flex flex-col p-4 rounded-3xl shadow-sm gap-[15px] h-fit bg-white transition-all duration-200 group hover:bg-mint-700">
                ...
                <div class="space-y-[10px]">
                    <p class="text-base font-semibold text-left text-neutral-900 group-hover:text-white">{{ __('Manage Orders Easily') }}</p>
                    <p class="text-sm text-left text-neutral-500 group-hover:text-white">{{ __('Simple dashboard to track orders, manage pricing, and handle customer requests.') }}</p>
                </div>
            </div>
            <div
                class="flex flex-col p-4 rounded-3xl shadow-sm gap-[15px] h-fit bg-white transition-all duration-200 group hover:bg-mint-700">
                ...
                <div class="space-y-[10px]">
                    <p class="text-base font-semibold text-left text-neutral-900 group-hover:text-white">{{ __('Mobile-Friendly Tools') }}</p>
                    <p class="text-sm text-left text-neutral-500 group-hover:text-white">{{ __('Accept orders, update status, and communicate with customers on-the-go.') }}</p>
                </div>
            </div>
            <div
                class="flex flex-col p-4 rounded-3xl shadow-sm gap-[15px] h-fit bg-white transition-all duration-200 group hover:bg-mint-700">
                ...
                <div class="space-y-[10px]">
                    <p class="text-base font-semibold text-left text-neutral-900 group-hover:text-white">{{ __('Dedicated Support') }}</p>
                    <p class="text-sm text-left text-neutral-500 group-hover:text-white">{{ __('24/7 store support team to help you succeed and resolve any issues quickly.') }}</p>
                </div>
            </div>
        @endif
    ...
    <div class="grid lg:hidden grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-7">
        ...
        <div
            ...
            <div class="space-y-[10px]">
                <p class="text-base font-semibold text-left text-neutral-900 group-hover:text-white">
                    {{ __('Grow Your Business') }}
                </p>
                <p class="text-sm text-left text-neutral-500 group-hover:text-white">
                    {{ __('Reach thousands of customers actively searching for dry cleaning services in your area.') }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div class="space-y-[10px]">
                <p class="text-base font-semibold text-left text-neutral-900 group-hover:text-white">
                    {{ __('Manage Orders Easily') }}
                </p>
                <p class="text-sm text-left text-neutral-500 group-hover:text-white">
                    {{ __('Simple dashboard to track orders, manage pricing, and handle customer requests.') }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div class="space-y-[10px]">
                <p class="text-base font-semibold text-left text-neutral-900 group-hover:text-white">
                    {{ __('Mobile-Friendly Tools') }}
                </p>
                <p class="text-sm text-left text-neutral-500 group-hover:text-white">
                    {{ __('Accept orders, update status, and communicate with customers on-the-go.') }}
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div class="space-y-[10px]">
                ...
                <p class="text-sm text-left text-neutral-500 group-hover:text-white">
                    {{ __('24/7 store support team to help you succeed and resolve any issues quickly.') }}
                </p>
            </div>
        </div>

        ...
        <div class="flex flex-col justify-center order-2 md:order-1">
            ...
            <div class="space-y-3 md:space-y-5">
                ...
                <div class="flex justify-center lg:justify-start">
                    <div
                        ...
                        <p class="text-[10px] sm:text-xs font-medium text-left text-mint-700">
                            {{ __('Trusted by 50,000+ Happy Customers') }}
                        </p>
                    </div>
                </div>

                <p class="text-2xl md:text-5xl font-bold text-center lg:text-left text-gray-900">
                    {{ $beforeAnd ?: __('Professional Dry Clean & Care') }} <br>
                    {{ __('And') }}
                ...
                <p class="text-lg md:text-2xl text-center lg:text-left text-neutral-500">
                    {{ $header['description'] ??
                        __('Experience hassle-free dry cleaning service with free pickup and delivery. Book in seconds, track in real-time, and enjoy fresh, clean clothes.') }}
                </p>
            </div>
            <div class="space-y-6 mt-4 md:mt-9">
                ...
                <div
                    ...
                    <div class="flex justify-start items-center gap-2">
                        ...
                        <p class="text-sm md:text-base text-left text-neutral-500">{{ __('Same-day service') }}</p>
                    </div>
                    <div class="flex justify-start items-center gap-2">
                        <img src="{{ asset('website/assets/icons/pickup.svg') }}" alt="" class="w-4 h-4">
                        <p class="text-sm md:text-base text-left text-neutral-500">{{ __('Free pickup') }}</p>
                    </div>
                    <div class="flex justify-start items-center gap-2">
                        <img src="{{ asset('website/assets/icons/map-pin.svg') }}" alt="" class="w-4 h-4">
                        <p class="text-sm md:text-base text-left text-neutral-500">{{ __('500+ vendors') }}</p>
                    </div>
                </div>
            </div>
        </div>

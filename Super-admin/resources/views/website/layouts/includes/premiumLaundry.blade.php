 <section
     ...
     <header class="relative z-10 space-y-[10px]">
         <p class="text-2xl md:text-[32px] text-center text-white">
             {{ __('Ready to') }} <span class="text-mint-600 font-playfair italic">{{ __('Experience Premium Dry Cleaning') }} </span>
             {{ __('Services?') }}
         </p>
         <p class=" text-sm md:text-base text-center text-neutral-50">
             {{ __('Join thousands of satisfied customers who trust us with their clothes every day.') }}
         </p>
     </header>

                ...
                <div class="grid grid-cols-12 gap-7">
                    ...
                    <div class="col-span-12 md:col-span-6">
                        <div class="sigin-right-side bg-white  rounded-3xl
                            p-6 relative">
                            <form action="{{ route('web.register') }}" method="POST" class="content">
                                @csrf
                                ...
                                <div class="input-items mb-4">
                                    ...
                                    <div class="relative">
                                        <img class="absolute"
                                            src="{{ asset('website/assets/icons/phone-grey.svg') }}" alt="">
                                        <input class="w-full" type="text" name="mobile"
                                ...
                                <div class="flex items-start gap-[10px] mb-6">
                                    <label for="card-1-container" class="flex items-center">
                                        <input type="checkbox" name="terms" id="card-1-container"
                                            {{ old('terms') ? 'checked' : '' }}
                                            class="peer sr-only">
                                        <img src="{{ asset('website/assets/icons/unchecked.svg') }}" alt=""
                                    ...
                                    <span class="text-base font-normal leading-[150%] text-neutral-500">
                                        I agree to the <a class="text-mint-600" href="{{ route('web.terms') }}">Terms
                                            of Service</a>
                                        and <a class="text-mint-600" href="{{ route('web.privacy') }}">Privacy
                                            Policy</a>
                                    </span>
                                </div>
                                <button type="submit"

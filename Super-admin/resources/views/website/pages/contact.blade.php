        ...
        <section
            ...
            <div class="rs-breadcrumb-content">
                ...
                <div class="rs-breadcrumb-top-content">
                    ...
                    <a href="#" class="text-base md:text-lg text-white font-normal leading-[100%]">{{ __('Contact') }}</a>
                </div>
            </div>
        </section>
            ...
            <div class="col-span-12 md:col-span-4 flex flex-col gap-4">
                ...
                <div class="flex flex-col p-4 rounded-3xl transition-all duration-200 shadow-sm gap-[15px] h-fit bg-white">
                    ...
                    <div class="flex flex-col justify-start items-start self-stretch relative gap-[5px]">
                        ...
                        <p class="text-sm text-left text-gray-500">{{ __('Mon-Fri from 8am to 6pm') }}</p>
                ...
                <div class="flex flex-col p-4 rounded-3xl transition-all duration-200 shadow-sm gap-[15px] h-fit bg-white">
                    ...
                    <div class="flex flex-col justify-start items-start self-stretch relative gap-[5px]">
                        ...
                        <p class="text-sm text-left text-gray-500">{{ __('Our team is here to help') }}</p>
                        <p class="text-base text-left text-mint-600">{{ $contact['email'] ?? 'support@elitedryclean.com' }}
                        </p>
                    </div>
                </div>
                ...
                <div class="flex flex-col p-4 rounded-3xl transition-all duration-200 shadow-sm gap-[15px] h-fit bg-white">
                    ...
                    <div class="flex flex-col justify-start items-start self-stretch relative gap-[5px]">
                        ...
                        <p class="text-sm text-left text-gray-500">{{ __('Monday - Friday: 8am - 6pm') }} <br>Saturday: 9am - 4pm
                            <br>Sunday: Closed
                        </p>
                    </div>
                </div>
            ...
            <div class="col-span-12 md:col-span-8 space-y-6">
                ...
                <form action="{{ route('web.contact.submit') }}" method="POST"
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-neutral-700 text-lg font-semibold">{{ __('Send Us A Message') }}</h3>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex justify-between items-center mt-1">
                            <p id="message-min" class="text-xs text-red-500 hidden">{{ __('Minimum 10 characters required') }}</p>

                                ...
                                <div class="row">
                                    ...
                                    <div class="card-icon">
                                        <div class="icon icon-shape text-white shadow">
                                            <img width="80" height="80" src="{{ asset('images/icons/earning.svg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="card-icon">
                                        <div class="icon icon-shape text-white shadow">
                                            <img width="80" src="{{ asset('images/icons/services.svg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        @can('revenue.index')
                            <div class="text-right">
                                ...
                                @can('revenue.generate.pdf')
                                    <a class="btn py-1 text-white print-same-page"
                                        href="{{ route('revenue.generate.pdf', ['type' => strtolower($type)]) }}"
                    ...
                    @can('dashboard.overview')
                        <div class="row p-3">
                            <div class="col-lg-6 col-4 mb-3">
                                <img width="50" src="{{ asset('images/icons/users.svg') }}" class="float-left mr-2"
                                    alt="">
                                <div>
                            ...
                            <div class="col-lg-6 col-4 mb-3">
                                <img width="50" src="{{ asset('images/icons/Orders.svg') }}" class="float-left mr-2"
                                    alt="">
                                <div>
                            ...
                            <div class="col-lg-6 col-4 mb-3">
                                <img width="50" src="{{ asset('images/icons/Pending.svg') }}" class="float-left mr-2"
                                    alt="">
                                <div>
                            ...
                            <div class="col-lg-6 col-4 mb-3">
                                <img width="50" src="{{ asset('images/icons/progress.svg') }}" class="float-left mr-2"
                                    alt="">
                                <div>
                            ...
                            <div class="col-lg-6 col-4">
                                <img width="50" src="{{ asset('images/icons/delivered.svg') }}" class="float-left mr-2"
                                    alt="">
                                <div>
                            ...
                            <div class="col-lg-6 col-4 ">
                                <img width="50" src="{{ asset('images/icons/order.svg') }}" class="float-left mr-2"
                                    alt="">
                                <div>

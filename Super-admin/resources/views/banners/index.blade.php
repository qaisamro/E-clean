                    ...
                    <div class="modal fade" id="createModal">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-header">
                                <h2 class="modal-title" id="exampleModalLabel">{{ __('Add Banner') }}</h2>
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="deleteModal_{{ $banner->id }}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                <div class="modal-header">
                                                    <h2 class="modal-title" id="exampleModalLabel">{{ __('Delete a banner') }}</h2>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                    <div class="modal-body">
                                                        <h3 class="text-warning">{{ __('Are you sure?') }}</h3>
                                                        <h5>{{ __('You want to permanently delete this banner.') }}</h5>
                                                        <img width="30%" src="{{ $banner->thumbnailPath }}" alt="">
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('Close') }}</button>
                                                        @role('visitor')
                                                        <button type="button" class="btn btn-danger visitorMessage">{{ __('Delete') }}</button>
                                                        @else

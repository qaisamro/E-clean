...
@section('content')
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-end mb-3">
            <button class="btn btn-primary" data-toggle="modal" data-target="#AddSubProduct">
                <i class="fa fa-plus"></i> {{ __('Add_New_Sub_Product') }}
            </button>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center py-2">
                        <h3 class="m-0">{{__('All_sub_products_under')}} {{ $product->name }} {{('product')}}</h3>
                                    ...
                                    @foreach ($product->subProducts as $subProduct)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('product.subproduct.delete', $subProduct->id) }}"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">{{ __('Edit_Sub_Product') }}</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" type="text" name="name"
                                                                    placeholder="{{__('Product_Name')}}" value="{{ $subProduct->name }}"
                                                                    required />
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="">{{ __('Product') . ' ' . __('Name') . ' ' . __('Arabic') }}</label>
                                                                <input class="form-control" type="text" name="name_bn"
                                                                    value="{{ $subProduct->name_bn }}" />
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="">{{__('Price')}}</label>
                                                                <input class="form-control" type="text" name="price"
                                                                    placeholder="{{__('Price_Add...')}}"
                                                                    value="{{ $subProduct->price }}" onkeypress="onlyNumber(event)" required />
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="">{{__('Discount') . ' ' . __('Price')}}</label>
                                                                <input class="form-control" type="text" name="discount_price"
                                                                    value="{{ $subProduct->discount_price }}" onkeypress="onlyNumber(event)" />
                                                            </div>
                                                            <div>
    ...
    <div class="modal fade" id="AddSubProduct">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{__('Add_Sub_Product')}}</h5>
                ...
                <form action="{{ route('product.subproduct.store', $product->id) }}" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <input class="form-control" name="name" type="text" placeholder="{{ __('Product') . ' ' . __('Name') }}" required/>

                        <label class="mb-1 mt-3">{{ __('Product') . ' ' . __('Name') . ' ' . __('Arabic') }}</label>
                        <input class="form-control" name="name_bn" type="text" placeholder="{{ __('Product') . ' ' . __('Name') . ' ' . __('Arabic') }}"/>

                        <label class="mb-1 mt-3">{{ __('Product') . ' ' . __('Price') }}</label>
                        <input name="price" type="text" class="form-control"
                            placeholder="{{ __('Product') . ' ' . __('Price') }}" onkeypress="onlyNumber(event)" required/>
                        ...
                        <div>
                            ...
                            <textarea name="description" required class="form-control" placeholder="{{ __('Description') }}"></textarea>
                        </div>

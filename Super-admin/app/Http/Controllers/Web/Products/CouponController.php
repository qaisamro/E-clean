...
class CouponController extends Controller
{
    ...
    public function store(CouponRequest $request)
    {
        ...
        if ($request->notify) {
            ...
            if ($notificationManage?->is_active) {
                ...
                (new NotificationServices())->sendNotification($message, $keys, 'Coupon Discount');

            }
        }

        return redirect()->route('coupon.index')->with('success', 'تمت إضافة الكوبون بنجاح.');
    }
    ...
    public function update(CouponRequest $request, Coupon $coupon)
    {
        ...
        return redirect()->route('coupon.index')->with('success', 'تم تحديث الكوبون بنجاح.');
    }
}

...
class LanguageController extends Controller
{
    ...
    public function store(LanguageRequest $request)
    {
        ...
        if (!file_exists($path)) {
            ...
            return redirect()->route('language.index')->withSuccess('تم الإنشاء بنجاح');
        }
    ...
    public function update(LanguageRequest $request, Language $language)
    {
        ...
        if (file_exists($filePath)) {
            ...
            return redirect()->route('language.index')->withSuccess('تم التحديث بنجاح');
        }
    ...
    public function delete(Language $language)
    {
        ...
        if ($language->name != 'en') {
            ...
            return redirect()->route('language.index')->withSuccess('تم الحذف بنجاح');
        }

...
class BannerController extends Controller
{
    ...
    public function store(BannerRequest $request)
    {
        ...
        return redirect()->route('banner.promotional')->with('success', 'تمت إضافة بانر جديد بنجاح');
    }
    ...
    public function update(BannerRequest $request, Banner $banner)
    {
        ...
        return redirect()->route('banner.promotional')->with('success', 'تم تحديث البانر بنجاح');
    }
    ...
    public function toggleActivationStatus(Banner $banner)
    {
        ...
        return back()->with('success', 'تم تحديث حالة البانر بنجاح');
    }
}
